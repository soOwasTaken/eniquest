      ...
      <form @submit.prevent="handleSubmit" class="login-form">
        ...
        <div v-if="mode === 'passwordChange'">
          <div class="input-holder">
            ...
            <input type="password" class="input" placeholder="New Password" v-model="newPassword" required />
          </div>
          <div class="input-holder">
            <i class="icon fas fa-lock"></i>
            <input type="password" class="input" placeholder="Confirm New Password" v-model="confirmNewPassword" required />
          </div>
          <div class="input-holder">
        ...
        <template v-else>
          ...
          <div class="input-holder" v-if="mode !== 'enterKey' && !showResetKeyInput && mode !== 'passwordChange'">
          ...
          <div class="input-holder" v-if="(mode === 'login' || mode === 'signup') && mode !== 'passwordChange'">
            <i class="icon fas fa-lock"></i>
          ...
          <div class="input-holder" v-if="mode !== 'passwordChange'">
            ...
            <p class="link" v-if="mode === 'login'" @click="toggleForgotPassword">Forget your password?</p>
          </div>
        </template>
      </form>
    </div>
  ...
  methods: {
    ...
    getButtonValue() {
        switch(this.mode) {
            ...
            case 'forgotPassword': return this.showResetKeyInput ? 'Verify Key' : 'Send Reset Email';
    ...
    verifyResetKey() {
        ...
        axios.post('/api/verify-reset-key', payload)
            .then(response => {
