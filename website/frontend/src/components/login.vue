<template>
  <div class="full-page">
    ...
    <button v-show="showButton" 
        ...
        style="opacity: 0;" 
        @click="enterSite" 
        class="enter-button">Enter the ᚨᚱᛖᚾᚨ</button>
...
export default {
  ...
  data() {
    return {
      ...
      translatedText: 'Welcome, This website is a unique ᚨᚱᛖᚾᚨ where the power of ᚠᚱᛖᛖ ᛊᛈᛖᛜᚻ challenges the shadows of ᛜᛖᚾᛊᛟᚱᛊᚻᛁᛈ. Unravel the enigmas hidden within and connect with fellow ᛏᚻᛁᚾᚲᛖᚱᛊ in a quest to uncover and share hidden ᛏᚱᚢᛏᚻᛊ᛬',
      displayText: '',
      flashActive: false,
      showButton: true,
      showParagraph: true,
