...
import OverlayComponent from './ClassicLogin.vue';
export default {
  components: {
    OverlayComponent
  },
  data() {
    return {
      runicText: 'ᚹᛖᛚᛜᛟᛗᛖ᛬ ᛏᚻᛁᛊ ᚹᛖᛒᛊᛁᛏᛖ ᛁᛊ ᚨ ᚢᚾᛁᛇᚢᛖ ᚨᚱᛖᚾᚨ ᚹᚻᛖᚱᛖ ᛏᚻᛖ ᛈᛟᚹᛖᚱ ᛟᚠ ᚠᚱᛖᛖ ᛊᛈᛖᛜᚻ ᛜᚻᚨᛚᛚᛖᚾᚷᛖᛊ ᛏᚻᛖ ᛊᚻᚨᛞᛟᚹᛊ ᛟᚠ ᛜᛖᚾᛊᛟᚱᛊᚻᛁᛈ᛬ ᚢᚾᚱᚨᛝᛖᛚ ᛏᚻᛖ ᛖᚾᛁᚷᛗᚨᛊ ᚻᛁᛞᛞᛖᚾ ᚹᛁᛏᚻᛁᚾ ᚨᚾᛞ ᛜᛟᚾᚾᛖᛜᏔ ᚹᛁᛏᚻ ᚠᛖᛚᛚᛟᚹ ᛏᚻᛁᚾᚲᛖᚱᛊ ᛁᚾ ᚨ ᛇᚢᛖᛊᏔ ᛏᛟ ᚢᚾᛜᛟᚾᚷᛖᚱ ᚨᚾᛞ ᛊᚻᚨᚱᛖ ᚻᛁᛞᛞᛖᚾ ᛏᚱᚢᛏᚻᛊ',
      translatedText: 'Welcome, This website is a unique arena where the power of free speech challenges the shadows of censor. Unravel the enigmas hidden within and connect with fellow thinkers in a quest to uncover and share hidden truths',
      displayText: '',
      flashActive: false,
      showButton: true,
      showParagraph: true,
...
@keyframes flashAnimation {
  0% { opacity: 0; }
  50% { opacity: 1; } /* Reach full opacity quickly */
  100% { opacity: 0; } /* And quickly fade out */
}
