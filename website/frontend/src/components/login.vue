<template>
  <div class="full-page">
    <div class="content">
      ...
      <OverlayComponent v-show="isVisible" />
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      translatedText:
        'Welcome, This website is a unique ᚨᚱᛖᚾᚨ where the power of ᚠᚱᛖᛖ ᛊᛈᛖᛜᚻ challenges the shadows of ᛜᛖᚾᛊᛟᚱᛊᚻᛁᛈ. Unravel the enigmas hidden within and connect with fellow ᛏᚻᛁᚾᚲᛖᚱᛊ in a quest to uncover and share hidden ᛏᚱᚢᛏᚻᛊ᛬',
      displayText: '',
      flashActive: false,
      showButton: true,
      showParagraph: true,
